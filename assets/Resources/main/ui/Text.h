...
#include "textures\TexturedQuad.h"
...
public:
    ...
    enum textAlignment {Left, Center, Rigth};
	Text();
	~Text();
	...
	void render(const string &str, const glm::vec2 &pixel, int size, const glm::vec4 &color, const textAlignment &align);
